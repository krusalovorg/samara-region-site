    ...
    const handleSubmit = async () => {
        ...
        if (token) {
            try {
                ...
                formDataToSend.append("type", "place");
            ...
            <div className="flex flex-row w-[100%] justify-between">
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className="mb-6">
                        ...
                        {
                            categorys.map(() => (
                                <button className='bg-[#FEEFD7] px-10 py-3 mb-[10px] rounded-2xl font-medium mt-auto w-full' onClick={handleSubmit}>Природа</button>
                            ))
                        }
